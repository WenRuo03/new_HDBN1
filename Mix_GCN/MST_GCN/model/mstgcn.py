...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=2,
        ...
        self.l11 = TCN_GCN_unit(256, 512, A, stride=2, adaptive=adaptive)
        self.l12 = TCN_GCN_unit(512, 512, A, adaptive=adaptive)
        self.l13 = TCN_GCN_unit(512, 512, A, adaptive=adaptive)
