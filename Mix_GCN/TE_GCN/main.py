...
# python main.py --device 0 --config config/uav-cross-subjectv2/train.yaml
# python main.py --device 0 --config ./config/TEGCN_joint.yaml
# python main.py --device 0 --config config/uav-cross-subjectv2/test.yaml
# python main.py --device 0 --config config/uav-cross-subjectv1/test_bone.yaml
